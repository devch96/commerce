 ...
 * 토스는 orderId·payableAmount·orderName으로 SDK를 띄우고, 카카오는 redirectUrl로 이동시킨다.
 */
@Getter
@Builder
public class OrderCheckoutResponse {
  ...
  public static OrderCheckoutResponse of(Long orderId, BigDecimal payableAmount, String orderName,
